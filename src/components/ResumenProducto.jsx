...
const ResumenProducto = ({producto}) => {
    ...
    // esto va a aparecer del lado derecho en el resumen (extraigo info del array de producto y lo muestro)
    const { handleEditarCantidad, handleEliminarProductoPedido } = useSnack()
